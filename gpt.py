...
# print(encode("Hey how are you?"))
# print(decode(encode("Hey how are you?")))
...
class MultiHeadAttention(nn.Module):
    """ Self attention comuptation using multiple heads in parallel"""
...
class GPTLangugageModel(nn.Module):
